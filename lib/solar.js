...
function getSolarData(date, latitude, longitude, timezone){
    ...
    result.solarnoonUTC = getSolarNoonDTUTC(date, latitude, longitude, timezone);
...
function getSolarNoonDTUTC(date, latitude, longitude, timezone){
